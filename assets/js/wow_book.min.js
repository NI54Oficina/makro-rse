...
(function(d) {
    if (!d.browser) {
        ...
        n = d.uaMatch(n);
        d.browser = {};
        n.browser && (d.browser[n.browser] = !0, d.browser.version = n.version);
        d.browser.webkit && (d.browser.safari = !0)
    }
})(jQuery);
jQuery.easing.jswing = jQuery.easing.swing;
jQuery.extend(jQuery.easing, {
    easeOutCubic: function(d, n, t, s, g) {
        return s * ((n = n / g - 1) * n * n + 1) + t
    },
    easeOutExpo: function(d, n, t, s, g) {
        return n == g ? t + s : s * (-Math.pow(2, -10 * n / g) + 1) + t
    }
});
window.Modernizr = function(d, n, t) {
    function s(a, b) {
        for (var c in a)
            if (w[a[c]] !== t) return "pfx" == b ? a[c] : !0;
        return !1
    }
    ...
    function g(a, b, c) {
        ...
        if ("string" === typeof b || "undefined" === typeof b) b = s(f, b);
        else a: {
    ...
    var B = ["Webkit", "Moz", "O", "ms"],
        ...
        b, e = function(a, b, c, e) {
            var f, r, d, h = n.createElement("div"),
                v = n.body,
                k = v ? v : n.createElement("body");
            if (parseInt(c, 10))
                for (; c--;) d = n.createElement("div"), d.id = e ? e[c] : "modernizr" + (c + 1), h.appendChild(d);
            return f = ["&#173;<style>", a, "</style>"].join(""), h.id = "modernizr", (v ? h : k).innerHTML += f, k.appendChild(h), v || (k.style.background = "", u.appendChild(k)), r = b(h, a), v ? h.parentNode.removeChild(h) : k.parentNode.removeChild(k), !!r
        },
        f = {}.hasOwnProperty,
        h;
    ...
    p.csstransforms3d = function() {
        var a = !!g("perspective");
        return a && "webkitPerspective" in u.style && (a = m.csstransforms3d), a
    };
    for (var k in p) h(p, k) && (b = k.toLowerCase(), m[b] = p[k](), a.push((m[b] ? "" : "no-") + b));
    w.cssText = "";
    return p = null, m._version = "2.5.3", m._prefixes = d, m._domPrefixes = A, m._cssomPrefixes = B, m.testProp = function(a) {
        return s([a])
    }, m.testAllProps = g, m.testStyles = e, m.prefixed = function(a, b, c) {
...
(function(d, n, t) {
    ...
    m = function() {
        function m() {
            var b = s(),
                k = f(c);
            b !== c ? (e(c = b, k), d(n).trigger("hashchange")) :
                k !== c && (location.href = location.href.replace(/#.*/, "") + k);
        ...
        d.browser.msie && !w && function() {
            var a, c;
            p.start = function() {
                a || (c = (c = d.fn.hashchange.src) && c + s(), a = d('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                    c || e(s());
                    m()
                }).attr("src", c || "javascript:0").insertAfter("body")[0].contentWindow, g.onpropertychange = function() {
                    try {
                        "title" ===
                        event.propertyName && (a.document.title = g.title)
                    } catch (b) {}
                })
            };
            p.stop = b;
            f = function() {
                return s(a.location.href)
            };
            e = function(b, c) {
                var e = a.document,
                    f = d.fn.hashchange.domain;
                b !== c && (e.title = g.title, e.open(), f && e.write('<script>document.domain="' + f + '"\x3c/script>'), e.close(), a.location.hash = b)
            }
        }();
        return p
    }()
...
! function(d, n) {
    function t() {
        g.READY || (q.determineEventTypes(), l.each(g.gestures, function(a) {
            z.register(a)
        }), q.onTouch(g.DOCUMENT, e, z.detect), q.onTouch(g.DOCUMENT, f, z.detect), g.READY = !0)
    }
    ...
    g.HAS_TOUCHEVENTS = "ontouchstart" in d;
    ...
    var m = {},
        u = g.DIRECTION_DOWN = "down",
        p = g.DIRECTION_LEFT = "left",
        w = g.DIRECTION_UP = "up",
        B = g.DIRECTION_RIGHT = "right",
        A = g.POINTER_MOUSE = "mouse",
        a = g.POINTER_TOUCH = "touch",
        c = g.POINTER_PEN = "pen",
        b = g.EVENT_START = "start",
        e = g.EVENT_MOVE = "move",
        f = g.EVENT_END =
        "end",
        h = g.EVENT_RELEASE = "release",
        k = g.EVENT_TOUCH = "touch";
    g.READY = !1;
    g.plugins = g.plugins || {};
    g.gestures = g.gestures || {};
    var l = g.utils = {
        extend: function(a, b, c) {
            for (var e in b) !b.hasOwnProperty(e) || a[e] !== n && c || (a[e] = b[e]);
            return a
        },
        on: function(a, b, c) {
        ...
        getCenter: function(a) {
            ...
            return 1 === a.length ? {
                ...
                (l.each(a, function(a) {
                    ...
                    pageX: (d.apply(Math, b) + h.apply(Math, b)) / 2,
                    pageY: (d.apply(Math, c) + h.apply(Math, c)) / 2,
                    clientX: (d.apply(Math, e) + h.apply(Math, e)) / 2,
                    clientY: (d.apply(Math, f) + h.apply(Math, f)) / 2
                })
        },
        ...
        getDirection: function(a, b) {
            ...
            return c >= e ? 0 < a.clientX - b.clientX ? p : B : 0 < a.clientY - b.clientY ? w : u
        },
        ...
        setPrefixedCss: function(a, b, c, e) {
            ...
            for (var d = 0; d < f.length; d++) {
                var h = b;
                if (f[d] && (h = f[d] + h.slice(0, 1).toUpperCase() + h.slice(1)), h in a.style) {
                    a.style[h] = (null == e || e) && c || "";
                    break
                }
            }
        },
    ...
    g.Instance = function(a, c) {
        ...
        this.options = l.extend(l.extend({}, g.defaults), c || {});
        ...
        this.eventStartHandler = q.onTouch(a, b, function(a) {
            e.enabled && a.eventType == b ? z.startDetect(e, a) : a.eventType == k && z.detect(a)
        });
        this.eventHandlers = []
    };
    g.Instance.prototype = {
        ...
        trigger: function(a, b) {
            b || (b = {});
            var c = g.DOCUMENT.createEvent("Event");
            c.initEvent(a, !0, !0);
            c.gesture = b;
            var e = this.element;
    ...
    var q = g.event = {
            ...
            onTouch: function(c, e, d) {
                var h = this,
                    k = function(k) {
                        var q, z = k.type.toLowerCase(),
                            D = g.HAS_POINTEREVENTS;
                        (z = l.inStr(z, "mouse")) && h.preventMouseEvents || (z && e == b && 0 === k.button ? (h.preventMouseEvents = !1, h.shouldDetect = !0) : D && e == b ? h.shouldDetect = 1 === k.buttons || C.matchType(a, k) : z || e != b || (h.preventMouseEvents = !0, h.shouldDetect = !0), D && e != f && C.updatePointer(e, k), h.shouldDetect && (q = h.doDetect.call(h, k, e, c, d)), q == f && (h.preventMouseEvents = !1, h.shouldDetect = !1, C.reset()), D && e == f && C.updatePointer(e, k))
                    };
                return this.on(c, m[e], k), k
            },
            doDetect: function(a, c, d, l) {
                var q = this.getTouchList(a, c),
                    ...
                    m = q.trigger,
                    p = q.length;
                c == b ? m = k : c == f && (m = h, p = q.length - (a.changedTouches ? a.changedTouches.length : 1));
                0 < p && this.started &&
                    (g = e);
                this.started = !0;
                a = this.collectEventData(d, g, q, a);
                return c != f && l.call(z, a), m && (a.changedLength = p, a.eventType = m, l.call(z, a), a.eventType = g, delete a.changedLength), g == f && (l.call(z, a), this.started = !1), g
            },
            determineEventTypes: function() {
                var a;
                return a = g.HAS_POINTEREVENTS ? d.PointerEvent ? ["pointerdown", "pointermove", "pointerup pointercancel lostpointercapture"] : ["MSPointerDown", "MSPointerMove", "MSPointerUp MSPointerCancel MSLostPointerCapture"] : g.NO_MOUSEEVENTS ? ["touchstart", "touchmove", "touchend touchcancel"] : ["touchstart mousedown", "touchmove mousemove", "touchend touchcancel mouseup"], m[b] = a[0], m[e] = a[1], m[f] = a[2], m
            },
            getTouchList: function(a, b) {
                if (g.HAS_POINTEREVENTS) return C.getTouchList();
                if (a.touches) {
        ...
        z = g.detection = {
            ...
            getCalculatedData: function(a,
                ...
                var d = this.current,
                    ...
                    z = d.lastCalcEvent,
                    m = d.lastCalcData;
                z && a.timeStamp - z.timeStamp > g.CALCULATE_INTERVAL && (b = z.center, c = a.timeStamp - z.timeStamp, e = a.center.clientX - z.center.clientX, f = a.center.clientY - z.center.clientY, q = !0);
                a.eventType != k && a.eventType != h || (d.futureCalcEvent = a);
            ...
            extendEventData: function(a) {
                var b = this.current,
                    c = b.startEvent,
                    b = b.lastEvent || c;
                a.eventType != k && a.eventType != h || (c.touches = [], l.each(a.touches, function(a) {
                    c.touches.push({
                        clientX: a.clientX,
                        clientY: a.clientY
                    })
            ...
            register: function(a) {
                var b = a.defaults || {};
                return b[a.name] === n && (b[a.name] = !0), l.extend(g.defaults, b, !0), a.index = a.index || 1E3, this.gestures.push(a), this.gestures.sort(function(a, b) {
    ...
    ! function(a) {
        ...
        g.gestures.Drag = {
            name: a,
            index: 50,
            handler: function(d, k) {
                var q =
                    z.current;
                if (!(0 < k.options.dragMaxTouches && d.touches.length > k.options.dragMaxTouches)) switch (d.eventType) {
                    case b:
                        c = !1;
                        break;
                    case e:
                        if (d.distance < k.options.dragMinDistance && q.name != a) break;
                        var g = q.startEvent.center;
                        if (q.name != a && (q.name = a, k.options.dragDistanceCorrection && 0 < d.distance)) {
                            var m = Math.abs(k.options.dragMinDistance / d.distance);
                            g.pageX += d.deltaX * m;
                            g.pageY += d.deltaY * m;
                            g.clientX += d.deltaX * m;
                            g.clientY += d.deltaY * m;
                            d = z.extendEventData(d)
                        }(q.lastEvent.dragLockToAxis || k.options.dragLockToAxis &&
                            k.options.dragLockMinDistance <= d.distance) && (d.dragLockToAxis = !0);
                        q = q.lastEvent.direction;
                        d.dragLockToAxis && q !== d.direction && (d.direction = l.isVertical(q) ? 0 > d.deltaY ? w : u : 0 > d.deltaX ? p : B);
                        c || (k.trigger(a + "start", d), c = !0);
                        k.trigger(a, d);
                        k.trigger(a + d.direction, d);
                        q = l.isVertical(d.direction);
                        (k.options.dragBlockVertical && q || k.options.dragBlockHorizontal && !q) && d.preventDefault();
                        break;
                    case h:
                        c && d.changedLength <= k.options.dragMaxTouches && (k.trigger(a + "end", d), c = !1);
                        break;
                    case f:
                        c = !1
                }
            ...
            handler: function(f, d) {
                ...
                switch (f.eventType) {
                    case b:
                        ...
                        break;
                    case e:
                        f.distance > k.holdThreshold && clearTimeout(c);
                        break;
                    case h:
                        clearTimeout(c)
                }
    ...
    g.gestures.Release = {
        ...
        index: 1 / 0,
        handler: function(a, b) {
            a.eventType == h && b.trigger(this.name, a)
        }
    };
    g.gestures.Swipe = {
        name: "swipe",
            ...
            handler: function(d, h) {
                ...
                switch (d.eventType) {
                    case b:
                        ...
                        break;
                    case e:
                        c = c || d.distance > g.tapMaxDistance;
                        break;
                    case f:
                        !l.inStr(d.srcEvent.type, "cancel") && d.deltaTime < g.tapMaxTime && !c && (k = p && p.lastEvent && d.timeStamp - p.lastEvent.timeStamp, q = !1, p && p.name == a && k && k < g.doubleTapInterval && d.distance < g.doubleTapDistance && (h.trigger("doubletap", d), q = !0), (!q || g.tapAlways) && (m.name = a, h.trigger(m.name, d)))
                }
            },
            defaults: {
                tapMaxTime: 250,
    ...
    g.gestures.Touch = {
        ...
        handler: function(a, b) {
            return b.options.preventMouse && a.pointerType == A ? void a.stopDetect() : (b.options.preventDefault && a.preventDefault(), void(a.eventType == k && b.trigger("touch", a)))
        }
    };
    (function(a) {
        var c = !1;
            ...
            handler: function(f, d) {
                switch (f.eventType) {
                    ...
                    case e:
                        ...
                        var k = Math.abs(1 - f.scale),
                            l = Math.abs(f.rotation);
                        if (k < d.options.transformMinScale && l < d.options.transformMinRotation) break;
                        z.current.name = a;
                        c || (d.trigger(a + "start", f), c = !0);
                        d.trigger(a, f);
                        l > d.options.transformMinRotation && d.trigger("rotate", f);
                        k > d.options.transformMinScale && (d.trigger("pinch", f), d.trigger("pinch" + (1 > f.scale ? "in" : "out"), f));
                        break;
                    case h:
...
(function(d) {
    function n(a, c) {
        ...
        if (e.length < c.pageCount) {
            for (var f =
                    c.pageCount - e.length; f--;) a.append("<div />");
            e = a.children()
        }
        ...
        b.shadowContainer = d(".wowbook-shadow-container",
            f);
        ...
        d(".wowbook-handle", f).on("mousedown.wowbook", function() {
            h = d.now();
            k = d(this).data("corner")
        }).on("mouseup.wowbook", function() {
            var a = d(this).data("corner");
            if (!((new Date).getTime() - h > b.opts.handleClickDuration || a != k)) {
                b.stopAnimation();
        ...
        a.hover(function(a) {
            if (b.pauseOnHover) {
                ...
                b.stopSlideShow();
                a.toggleClass("wowbook-disabled",
                    c)
            }
        }, function() {
        ...
        this.zoomWindow = d(".wowbook-zoomwindow",
            a);
        ...
        if (c.deepLinking && this.getLocationHash()) {
            ...
            "number" === typeof q && (b.startPage = q, s(b.elem) || b.elem[0].scrollIntoView())
        }
        this.flipSound && (this.audio = this.createAudioPlayer());
        if (this.opts.keyboardNavigation) d(document).on("keydown.wowbook", function(a) {
            d(a.target).filter("input, textarea, select").length || (a.which === b.opts.keyboardNavigation.back &&
        ...
        d(window).on("hashchange.wowbook", function() {
            ...
            if (a === b.locationHashSetTo) b.locationHashSetTo = void 0;
                ...
                "number" === typeof c && (b.gotoPage(c, !a), a || s(b.elem) || b.elem[0].scrollIntoView())
            }
        });
    ...
    function g(a, c, b) {
        ...
        if (!d.wowBook.support.boxSizing) {
            var l;
            e = "none" == a.css("borderTopStyle") ? 0 : u[l = a.css("borderTopWidth")] || parseFloat(l);
            f = "none" == a.css("borderRightStyle") ? 0 : u[l = a.css("borderRightWidth")] || parseFloat(l);
            h = "none" == a.css("borderBottomStyle") ? 0 : u[l = a.css("borderBottomWidth")] || parseFloat(l);
            k = "none" == a.css("borderLeftStyle") ? 0 : u[l = a.css("borderLeftWidth")] || parseFloat(l);
            f = parseFloat(a.css("paddingLeft")) + parseFloat(a.css("paddingRight")) + k + f;
    ...
    n.prototype = {
        ...
        setDimensions: function(a, c) {
            ...
            this._originalWidth || (this._originalWidth =
                2 * this.pageWidth);
            ...
            if (e && this.centeredWhenClosed) {
                var k = parseFloat(h.css("left"), 10);
                h.css("left", k / (e / this.pageWidth))
            }
            this.bookShadow.css({
                width: a,
                height: c
            });
            for (var k = 0, l = this.pages.length; k < l; k++) this.pages[k].css({
                width: this.pageWidth,
                height: this.pageHeight,
                left: this.pages[k].onLeft ? 0 : this.pageWidth
            }), e = d(".wowbook-page-content", this.pages[k]), g(e, this.pageWidth, this.pageHeight);
            ...
            this.clipBoundaries && (h = Math.ceil(Math.sqrt(this.pageWidth * this.pageWidth + this.pageHeight * this.pageHeight)), h = [this.pageHeight - h, b.width(), h, 0], this.origin.css("top", -h[0]), d(".wowbook-inner-clipper", b).css({
                width: "100%",
                height: h[2] - h[0],
                top: h[0]
            }), this.clipper.css({
        ...
        scaleToFit: function(a, c) {
            ...
            if (!d.isNumeric(a)) {
                ...
                b = e.width();
                //c = e.height();
				c= $(window).height()-$(".revista_nav .row").height()-100;
			...
			$('.revista_nav_outter').css("width",$(".page").width());
        },
        resize: function(a, c) {
			console.log("dimensions "+a+" "+c);
        ...
        insertPage: function(a, c) {
            if (this.isDoublePage(a)) this.insertDoublePage(a, c);
                ...
                g(a, this.pageWidth, this.pageHeight);
        ...
        insertDoublePage: function(a, c) {
            if (!this._insertingDoublePage) {
                ...
                d.wowBook.support.boxSizing || (g(b, 2 * this.pageWidth, this.pageHeight), g(e, 2 * this.pageWidth, this.pageHeight));
                c || this.updateBook();
        ...
        updateBook: function(a) {
            ...
            for (var c = this.rtl, b, e = 0, f = this.pages.length; e < f; e++) {
                ...
                b.pageIndex = e;
                var h = d(".wowbook-page-content", b);
                b.src = this.replaceNumberHolder(h.data("src") || this.opts.srcs, e);
                b.image = this.replaceNumberHolder(h.data("image") || this.opts.images, e);
                !0 != b.loaded && (b.loaded = !b.src && !b.image);
                b.loaded ||
                    b.addClass("wowbook-loading");
                b.onLeft = c;
                b.onRight = !c;
                c = !c
            }
        ...
        doPageNumbering: function() {
            ...
            if (a.pageNumbers) {
                ...
                for (b = e; b <= c; b++) a = d(".wowbook-page-number", this.pages[b]), a.length || (a = d(".wowbook-page-content", this.pages[b]), a = d('<div class="wowbook-page-number"></div>').appendTo(a)), a.html(f++)
            }
        },
        findPagesType: function() {
            ...
            var d = !0 === f;
            if (!d)
                for (a.hardcovers && (f.push(0, 1, -1), this.pageIsOnTheLeft(this.pages.length - 1) && f.push(-2)), a = 0, e = f.length; a < e; a++) b = f[a], 0 > b && (b = this.pages.length + b), 0 <= b && b < this.pages.length &&
                    (c[b] = !0);
            for (a = this.pages.length; a--;) f = d || c[a] || this.pages[a].hardPageSetByUser, this.pages[a].toggleClass("wowbook-hardpage", f).isHardPage = f
        },
        showPage: function(a, c) {
            ...
            for (var m =
                    0; m <= l; m++) q = this.pages[m].onLeft != this.rtl ? m : l - m, g = m === f || m === b || m === e || m === h ? "block" : "none", this.pages[m].data("zIndex", q).css({
                display: g,
                left: this.pages[m].onLeft ? 0 : k,
                top: 0,
                zIndex: q
            });
            f = 0 == a;
            ...
            (b = this.onShowPage) && d.isFunction(b) &&
                !this.isOnPage(a) && (this.currentPage = a, b(this, this.pages[a], a), (e = this.otherPage(a)) && b(this, this.pages[e], e));
            this.currentPage = a;
            this.centeredWhenClosed && (b = !!this.leftPage(a), e = this.rightPage(a), this.origin.css("left", b && e ? 0 : b ? k / 2 : -k / 2));
            this.positionBookShadow();
        ...
        holdPage: function(a, c, b, e, d) {
            ...
            if (a) {
                var h =
                    ...
                    l = !this.otherPage(k);
                if (!e) e = this.pageIsOnTheLeft(h) ? "l" : "r";
                else if (!this.corners[e] || (this.pageIsOnTheLeft(h) ? /r/ : /l/).test(e)) return;
                void 0 === d && (d = this.backPage(h));
                if (d) {
                    var q = d.pageIndex;
                    a.data("holded_info", [c, b, e]);
                    if (this.centeredWhenClosed && (0 === h || 0 === q || l && (q === k || h === k))) {
                        var g = 0,
                            m, p = !this.rtl,
                            r = this.pageWidth,
                            n, u, v, t, w, s, B, A;
                        if (p ? 0 === h : h === k && l) n = -r / 2, u = -r / 4, v = 0, t = -r / 2, w = -r, s = u, B = w, A = c;
                        if (p ? h === k && l : 0 === h) n = r, u = 3 * r / 2, v = r / 2, t = 0, w = r, s = 2 * r, B = c, A = s;
                        if (p ?
                            0 === q : q === k && l) n = r / 2, u = h === (p ? k : 0) ? r : 3 * r / 2, v = h === (p ? k : 0) ? r / 2 : 0, t = -r / 2, w = n, s = 2 * r, B = c, A = s;
                        if (p ? q === k && l : 0 === q) n = h === (p ? 0 : k) ? 0 : -r / 2, u = r / 2, v = r / 2, t = h === (p ? 0 : k) ? -r / 2 : 0, w = -r, s = u, B = w, A = c;
                        c < n && (g = v, m = B);
                        c > u && (g = t, m = A);
                        c >= n && c <= u && (c = (c - n) / (u - n), g = v + c * (t - v), m = w + c * (s - w));
                        c = m;
                        this.origin.css("left", g);
                        this.positionBookShadow()
                    }
                    ...
                    if (!a.data("holded") &&
                        (a.addClass("wowbook-page-holded"), d.addClass("wowbook-page-holded"), a.data("holded", !0), this.holdedPage = a, this.holdedPageBack = d, this.shadows && this.shadowClipper.css("display", "block"), this.clipBoundaries && this.clipper.css("overflow", "visible"), this.positionBookShadow(), this.opts.onHoldPage)) this.opts.onHoldPage(this, h, a, d)
                }
            }
        },
        ...
        foldPageStart: function(a, c, b, e, d) {
            ...
            if (d && d.length) {
                h.back = d;
                h.pageContent = a.children().first();
                h.backContent = d.children().first();
                var k = this.pageWidth,
                    l = this.pageHeight;
                e || (e = "tl");
                if ("l" == e || "r" == e) {
                    var g = {
                ...
                h.page.data("holdedAt", {
                    x: c,
                    y: b
                });
                h.x = c;
                h.y = b;
                h.page.data("holdedCorner", e);
                h.corner = e;
                h.pageDiagonal = Math.sqrt(k * k + l * l);
                h.page.css("clip", "rect(-1000px 2000px 2000px 0px)");
                h.pageLeft = parseFloat(a.css("left"));
                d.css({
                    left: h.pageLeft + "px",
                    zIndex: 1E3,
                    clip: "rect(-1000px 2000px 2000px 0px)"
                });
                h.shadowHeight = 2 * Math.ceil(h.pageDiagonal);
                h.shadowTop = -(h.shadowHeight - l) / 2;
                ...
                this.foldGradientContainer.appendTo(h.backContent);
                h.foldGradientWidth = this.foldGradientElem.width();
                h.foldGradientHeight = 2 * Math.ceil(h.pageDiagonal);
                this.foldGradientElem.css("height", h.foldGradientHeight);
                this.foldGradientContainer.css({
                    position: "absolute",
                    width: h.foldGradientWidth,
                    height: h.foldGradientHeight,
                    top: 0,
                    left: 0,
                    display: "none"
                });
                h.foldGradientVisible = !1;
                return h
            }
        },
        foldPageStyles: function(a) {
            ...
            if ("l" == p || "r" == p) {
                ...
                p = (g >= n.y ? "t" : "b") + (this.pageIsOnTheLeft(a.pageIndex) ? "l" : "r");
                a.corner = p;
                a.page.data("holdedCorner", p);
                var r = l - n.x,
                    u = g - n.y,
                    r = Math.atan2(u, r),
                    n = {
            ...
            s = t(w, g);
            v = s.x + l + e + .5;
            a.pageContent.css("transform", h(-v, 0) + " rotate(" + (-r).toFixed(7) + "deg)");
            a.page.css("transform", h((Math.cos(g) * v).toFixed(5), (Math.sin(g) * v).toFixed(5)) + " rotate(" + r.toFixed(7) + "deg)");
            s = this.calculateOpacity(l, c, this.shadowThreshold, 50);
            if (this.shadows &&
                0 < s) {
                var B = a.shadowTop;
                this.internalShadow.css({
                    transform: h(v + k, B) + " rotate(" + r + "deg)",
            ...
            k = -(k.x + e);
            b = -(b.y - f);
            a.backContent.css("transform", h(-v, 0) + " rotate(" + r + "deg)");
            a.back.css("transform", h((p + k + Math.cos(g) * v).toFixed(5), (n - b + Math.sin(g) * v).toFixed(5)) + " rotate(" + r + "deg)");
            s = this.calculateOpacity(2 * l, 2 * c, this.foldGradientThreshold, 50);
            this.foldGradient && 0 < s ? (this.foldGradientContainer.css({
                    opacity: s,
                    display: "block",
                    transform: h(c - p - a.foldGradientWidth / 2, n - a.foldGradientHeight / 2) + " rotate(" + -r + "deg)"
                }), this.foldGradientElem.css("transform", h(-l + a.foldGradientWidth / 2, 0)), a.foldGradientVisible ||
        ...
        flipHardPageStart: function(a,
            ...
            if (d && d.length) {
                ...
                this.opts.use3d && Modernizr.csstransforms3d && (a.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"), d.css(Modernizr.prefixed("perspectiveOrigin"),
                    "0 50%"));
                c = this.pageIsOnTheLeft(h.pageIndex) ? k : 0;
                a.css("transformOrigin", c + "px 50%");
                d.css("transformOrigin", k - c + "px 50%");
        ...
        flipHardPageStyles: function(a) {
            ...
            0 > a && (a = 0);
            a = (g = a < f) ? c : b;
            (g ? b : c).css("display", "none");
            c = e != g;
            b = x - k;
            b > f && (b = f);
            b < -f && (b = -f);
            k = -Math.sqrt(1600 * (1 - b * b / ((f + 15) * (f + 15))));
            e = Math.abs(b / f);
            k = 1 == e ? 0 : Math.atan2(k, b);
            if (this.opts.use3d && Modernizr.csstransforms3d) {
                var q;
                q = c ? -this._calculateAngleFromX(-b, f) : this._calculateAngleFromX(b, f);
                this.animating && (g = this._animationData, this.curledPage || g.curled ? (g.curled = !0, g.angle || (k = {
                        from: q,
                        to: 0
                    }, g.angle = k, q = b + g.dx, k.to = c ? -this._calculateAngleFromX(-q, f) : this._calculateAngleFromX(q, f), Math.abs(b) == f && (k.from = 0), Math.abs(q) == f && (k.to = 0), k.delta = k.to - k.from), q = g.angle.from -
                    g.angle.delta * (g.from.x - x) / g.dx) : (Math.abs(x - g.from.x), Math.abs(g.dx / 2)));
                a.css({
                    transform: "perspective(" + this.opts.perspective + this.perspectiveUnit + ") rotate3d(0, 1, 0, " + q + "deg)",
                    display: "block"
                })
            } else a.css({
                transform: "skewY(" + k + "rad) scaleX(" + e + ")",
                display: "block"
            });
            !d.wowBook.support.transform && d.wowBook.support.filters && (e = "M11=" + e + ", M12=0, M21=" + Math.tan(k) * e + ", M22=1", a.css("filter", "progid:DXImageTransform.Microsoft.Matrix(" + e + ", sizingMethod='auto expand')"), a.css({
                marginTop: h - a.height(),
        ...
        _calculateAngleFromX: function(a, c, b) {
            ...
            b *= b;
            var h = a * a;
            a = Math.acos((c * b * a - Math.sqrt(d * d * b * h + d * d * h * h - d * b * h * h)) / (d * b + d * h));
            return a = -a * e
        },
        ...
        foldPageBasicStyles: function(a) {
            ...
            var h = (d = this.pageIsOnTheLeft(a.pageIndex)) ? x : e - x;
            0 > h && (h = 0);
            h > 2 * e && (h = 2 * e);
            var k = h / 2,
                g, q;
            d ? (g = "rect(-1000px 1000px 1000px " + k + "px)", q = "rect(-1000px 1000px 1000px " + (e - k) + "px)", h -= e) : (g = "rect(-1000px " + (e - k) + "px 1000px -1000px)", q = "rect(-1000px " + k + "px 1000px -1000px)", h = e - h + e);
            c.css("clip", g);
            b.css({
                clip: q,
                left: h,
            ...
            c = this.calculateOpacity(2 * k, 2 * e, this.shadowThreshold, 50);
            this.shadows && 0 < c ? (b = d ? k - a.foldShadowWidth : e - k + e, this.shadowContainer.css("opacity", c), this.foldShadow.css({
                left: b,
                display: "block"
            })) : this.foldShadow.css("display", "none");
            c = this.calculateOpacity(2 * k, 2 * e, this.foldGradientThreshold, 50);
            this.foldGradient && 0 < c ? (b = d ? e - k : k - a.foldGradientWidth, this.foldGradientContainer.css({
                opacity: c,
                left: b,
                display: "block"
        ...
        animateFoldPage: function(a,
            ...
            if (!q.animating) {
                ...
                var m = b.x - e.x,
                    p = b.y - e.y,
                    n, r;
                void 0 == g && (g = this.turnPageDuration * Math.abs(m) / (2 * this.pageWidth));
                g < this.opts.turnPageDurationMin && (g = this.opts.turnPageDurationMin);
                !a.isHardPage && .4 < g / this.turnPageDuration && this.playFlipSound();
                this._animationData = {
                    from: b,
                    to: e,
                    dx: -m
                };
                this.holdPage(a, b.x, b.y, c, k);
                this._percent = 0;
                d(this).animate({
                    _percent: 1
                }, {
                    ...
                    step: function(e, d) {
                        n = b.x - e * m;
                        r = b.y - e * p;
                        h && (r -= (.5 - Math.abs(.5 - e)) * q.pageHeight / 10);
                        q.holdPage(a, n, r, c, k)
                    }
                })
            }
        },
        ...
        flip: function(a, c, b, e) {
            ...
            if (!f.animating) {
                ...
                var h = b.data("holded_info");
                b.data("holdedAt");
                var g = e.corner || b.data("holdedCorner"),
                    l = d.easing[e.easing] || e.easing ||
                    function(a) {
        ...
        releasePage: function(a, c, b, e) {
            ...
            else if (c = a.data("pageIndex"), void 0 === b && (b = this.holdedPageBack || this.backPage(c)), this.holdedPageBack =
                this.holdedPage = null, a.data({
                    holded_info: null,
                    holdedAt: null,
                    holdedCorner: null,
                    grabPoint: !1,
        ...
        gotoPage: function(a, c) {
            ...
            if (!this.animating && (this._cantStopAnimation = !0, "string" === typeof a && "#" == a.charAt(0) && (a = this.selectorToPage(a)), 0 > a && (a = 0), a > this.pages.length - 1 && (a = this.pages.length - 1), !this.isOnPage(a))) {
                ...
                b = this.rtl ? a > this.currentPage :
                    d;
                var h = this,
                    g = b ? h.leftPage() : h.rightPage();
                if (g) {
                    this.uncurl(!0);
                    var l, m;
                    b ? (l = this.leftPage(a), m = this.rightPage(a)) : (l = this.rightPage(a), m = this.leftPage(a));
                    var p = m && m.is(":visible");
                    if (d)
                    ...
                    p && m.css("display", "block");
                    var n = a;
                    l = g.data("holdedAt");
                    p = g.data("holdedAt");
                    d = g.data("holdedCorner") || (b ? "tl" : "tr");
                    b ? (p = p || {
                        x: 0,
                        y: 0
                    }, b = 2 * h.pageWidth, e = "bl" != d ? 0 : this.pageHeight) : (p = p || {
                        x: this.pageWidth,
                        y: 0
                    }, b = -h.pageWidth, e = "br" != d ? 0 : this.pageHeight);
                    var u = "linear";
                    if (this.centeredWhenClosed && (g.isHardPage || m.isHardPage)) {
                        var r = this.pages.length - 1,
                            s = !this.rtl,
                            u = "easeOutCubic";
                        this.currentPage == (s ? 0 : r) && (b += this.pageWidth / 2, s ? a == r && this.pageIsOnTheLeft(a) : 0 == a) && (b += this.pageWidth / 2);
                        this.currentPage == (s ? r : 0) && (b -= this.pageWidth / 2, a == (s ? 0 : r) && (b -= this.pageWidth / 2))
                    }
                    h.flip({
                        from: [p.x, p.y],
                        to: [b, e],
        ...
        rightPage: function(a) {
            void 0 === a && (a = this.currentPage);
            return this.pages[this.rightPageIndex(a)] ||
                null
        },
        ...
        calculateOpacity: function(a, c, b, e) {
            if (a <= b || a >= c - b) return 0;
            if (a >= e && a <= c - e) return 1;
            a > e && (a = c - a);
            return (a - b) / (e - b)
        },
        ...
        pageToSection: function(a) {
            for (var c = this.sections, b, e = 0, d = c.length; e < d && !(c[e].page > a); e++) b = c[e];
            return b
        },
        ...
        fillToc: function(a, c) {
            ...
            if (0 !== b.length) {
                ...
                c || (h = b.is("UL, OL") ? "<li>" : "<div>", c = '<a href="${link}">${section}</a>');
                for (var g = 0, l = e.length; g < l; g++) f =
                    e[g], f = c.replace(/\$\{link\}/g, "#" + this.id + "/" + f.id.substr(1)).replace(/\$\{section\}/g, f.title).replace(/\$\{page\}/g, f.page), d(f).appendTo(b).wrap(h)
            }
        },
        ...
        _zoomUpdateOnRAF: function() {
            if (this._zoomDataRAF) {
                ...
                a.transform = !0;
                this._zoom(b, a);
                c && 1 > Math.abs(e) && 1 > Math.abs(f) && 1 > Math.abs(this.zoomLevel - b) && (this._zoomDataRAF.callback &&
                    this._zoomDataRAF.callback.call(this), this._zoomDataRAF = null)
            }
        },
        _zoom: function(a, c) {
            c || (c = {});
            ...
            m = l.left - n.left;
            n = l.top - n.top;
            m && (h.css("marginLeft", m), g.marginLeft = m);
            n && (h.css("marginTop", n), g.marginTop = n);
            h = "";
            n = this._zoomOffset.dx / e;
            m = this._zoomOffset.dy / e;
            d.wowBook.support.transform && (n || m) ? h = d.wowBook.utils.translate(n, m) : g.css({
                left: n,
                top: m
            });
            b ? (f /= e, h += this.opts.useScale3d ? "scale3d(" + f + "," + f + ",1)" : "scale(" + f + ")") : (this._cssZoom = f, g.css("zoom", f), g.css("marginLeft", -g.marginLeft / e), g.css("marginTop", -g.marginTop / e));
            d.wowBook.support.transform &&
                g.css("transform", h);
            1 !== this.zoomLevel ? this.zoomed || (g.css("marginLeft", -g.marginLeft / e), g.css("marginTop", -g.marginTop / e), b && g.css("transformOrigin", "0 0")) : this.zoomFinished();
            this.zoomed = 1 !== a;
        ...
        zoom: function(a, c, b) {
            ...
            if (a !== this.zoomLevel || b.force)
                if (void 0 == c && (c = this.opts.zoomDuration), 0 == c) {
                    ...
                    finalOffset = b.offset || this.zoomFocusOffset(a, f, g);
        ...
        zoomTouchSupport: function() {
            if (this.opts.touchEnabled) {
                ...
                }).on("release.wowbook", function(b) {
                    0 == b.gesture.changedLength && (a.zoomContent.removeClass("wowbook-dragging"), b = a.zoomLevel,
                        b < a.zoomMin || b == a.zoomMin && (a._zoomOffset.dx || a._zoomOffset.dy) ? a.zoomReset() : a._zoom(b, {
                            force: !0,
                        ...
                        if (g) {
                            ...
                            "dragend" == c.type ? b = null : (a._zoomDataRAF = {
                                ...
                                options: {
                                    force: !0,
                                    offset: {
                                        dx: b.offset.dx + (g.center.pageX - b.pageX),
                                        dy: b.offset.dy +
                                            (g.center.pageY - b.pageY)
                                    }
                                }
                            }, g.preventDefault())
                        }
                ...
                if (a.opts.pinchToZoom) a._hammer.on("pinch.wowbook transformstart.wowbook transformend.wowbook", function(f) {
                    ...
                    if (g) {
                        ...
                        if ("transformend" == f.type) e = null;
                        else {
                            f = e.level * g.scale;
                            f > a.zoomMax && (f = a.zoomMax);
                            var m = a.zoomFocusOffset(f, e.x, e.y, e.offset,
                                e.level);
                            m.dx += k - e.pageX;
                            m.dy += l - e.pageY;
                            a._zoomDataRAF = {
        ...
        zoomDragSupportForIE: function() {
            var a = this,
                ...
                e = function(c) {
                    c = a.zoomLevel;
                    (c < a.zoomMin || c == a.zoomMin && (a._zoomOffset.dx || a._zoomOffset.dy)) && a.zoomReset();
                    d(document).unbind("mousemove.wowbook", b);
                    d(document).unbind("mouseup.wowbook",
                        e)
                };
        ...
        setupFullscreen: function() {
            if (B) {
                ...
                this._fullscreenChangeHandler = function() {
                    var b = p.fullscreenElement || p.mozFullScreenElement || p.webkitFullscreenElement || p.msFullscreenElement;
        ...
        toggleFullscreen: function() {
            p.fullscreenElement || p.mozFullScreenElement || p.webkitFullscreenElement || p.msFullscreenElement ? this.exitFullscreen() : this.enterFullscreen()
        },
        positionBookShadow: function() {
            ...
            if (c) {
                var c = this.pageWidth,
                    ...
                    e = !!b && b.onRight && b.pageIndex == (this.rtl ? a - 1 : 0);
                liftingLastPageOnRight = !!b && b.onLeft && b.pageIndex == (this.rtl ? 0 : a - 1);
                noPageOnLeft = !this.leftPage() || e;
                noPageOnRight = !this.rightPage() || liftingLastPageOnRight;
                onePageVisible = noPageOnLeft != noPageOnRight;
                noPageOnLeft && noPageOnRight ? this.bookShadow.hide() : (a = this.opts.zoomUsingTransform ?
                    this.currentScale * this.zoomLevel : 1, this.bookShadow.css({
        ...
        touchSupport: function() {
            ...
            d(document).on("touchend.wowbook touchcancel.wowbook", function(c) {
                if (a._touchStarted) {
                    !a._touchEnded && d(c.target).hasClass("wowbook-handle") &&
                        (c = d(c.target).data("corner"), "r" === c && a.advance(), "l" === c && a.back());
            ...
            if (!(this.curledPage || this.holdedPage ||
                ...
                if (a && !a.isCurled) {
                    ...
                    var b = this.pageIsOnTheLeft(a.pageIndex),
                        e = b ? 0 : this.pageWidth,
                        d = c ? this.pageHeight - 1 : 2;
                    this.flip({
                        from: [e, d],
                        to: [e + this.opts.curlSize * (b ? 1 : -1), d + this.opts.curlSize * (c ? -1 : 1)],
                        corner: (c ? "b" : "t") + (b ? "l" : "r"),
                        page: a,
                        duration: 400
                    })
        ...
        uncurl: function(a, c) {
            if (this.curledPage) {
                ...
                if ("number" ==
                    typeof a || "string" == typeof a) a = this.pages[+a];
        ...
        initThumbnails: function() {
            ...
            c.addClass(a.thumbnailsVertical ?
                "wowbook-vertical" : "wowbook-horizontal");
            var e = this,
        ...
        thumbnailConfig: function() {
            ...
            d.wowBook.support.transform ?
                a.cloneCSS.transform = "scale(" + f + ")" : a.cloneCSS.zoom = f;
            return a
        },
        createThumbnail: function(a, c) {
            ...
            if (b) {
                ...
                this.opts.thumbnailsSprite ? e.css("background", "url(" + this.opts.thumbnailsSprite + ") no-repeat 0px -" + a * c.height + "px") : (b = b.clone(), b.hasClass("wowbook-page-holded") && (this.resetPage(b),
                    b.find(".wowbook-fold-gradient-container").remove()), b.css(c.cloneCSS), e.prepend(b));
                var f = this;
                e.click(function() {
                    f.gotoPage(a)
                });
        ...
        updateThumbnails: function() {
            if (this.thumbnails) {
                for (var a = this.thumbnailConfig(), c =
                        0, b = this.pages.length; c < b; c++) this.updateThumbnail(c, a);
        ...
        showThumbnails: function(a) {
			$(".page").css("padding-left",$(".wowbook-vertical.wowbook-thumbnails").width());
			...
			this.scaleToFit($(window).width()-$(".wowbook-vertical.wowbook-thumbnails").width()-60,$(window).height()-60-$('.revista_nav_outter').height());
			$('.revista_nav_outter').css("width",$(window).width()-$(".wowbook-vertical.wowbook-thumbnails").width());
        },
        hideThumbnails: function(a) {
			...
			var aux=this;
			this.scaleToFit($(window).width()-60,$(window).height()-60-$('.revista_nav_outter').height());
			$('.revista_nav_outter').css("width",$(window).width());
        },
    ...
    "undefined" != typeof QUnit && (d.wowBook.wowBook = n);
    window.raf = function() {
    ...
    var m = d.browser.msie && 9 > d.browser.version ? 1 : 0,
        u = {
            thin: 2 - m,
            medium: 4 - m,
            thick: 6 - m
        ...
        p = window.document,
        w = p.documentElement,
        B = w.requestFullscreen || w.mozRequestFullScreen || w.webkitRequestFullscreen || w.msRequestFullscreen,
        A = p.exitFullscreen || p.mozCancelFullScreen || p.webkitExitFullscreen || p.msExitFullscreen;
    d.wowBook.utils = {
...
(function(d) {
    function n(g) {
        ...
        g = d.event.fix(m);
        g.type = "mousewheel";
        m.wheelDelta && (p = m.wheelDelta / 120);
        m.detail && (p = -m.detail / 3);
        t = p;
        void 0 !== m.axis && m.axis === m.HORIZONTAL_AXIS && (t = 0, s = -1 * p);
    ...
    if (d.event.fixHooks)
        for (var s = t.length; s;) d.event.fixHooks[t[--s]] =
            d.event.mouseHooks;
    d.event.special.mousewheel = {
        setup: function() {
            if (this.addEventListener)
                for (var d = t.length; d;) this.addEventListener(t[--d], n, !1);
            else this.onmousewheel = n
        },
        teardown: function() {
            if (this.removeEventListener)
                for (var d = t.length; d;) this.removeEventListener(t[--d], n, !1);
...
(function(d) {
    function n(g) {
        if (g in t.style) return d.wowBook.support[g] = g;
        for (var m = s.length, n, p = g.charAt(0).toUpperCase() + g.substr(1); m--;)
            if (n = s[m] + p, n in t.style) return d.wowBook.support[g] = n
    }
    if (d.cssHooks) {
        ...
        t = null;
        d.each(["transform", "transformOrigin"], function(g, m) {
            d.wowBook.support[m] &&
                d.wowBook.support[m] !== m && !d.cssHooks[m] && (d.cssHooks[m] = {
                    get: function(g, n, s) {
                        return d.css(g, d.wowBook.support[m])
                    },
                    set: function(g, n) {
                        g.style[d.wowBook.support[m]] = n
                    }
                })
        });
        d.wowBook.applyAlphaImageLoader = function(g) {
            var m, n, p, s, t = "",
                A = d("<div style='display:none'></div>").appendTo("body");
            n = 0;
            for (p = g.length; n < p; n++)
                if (s = g[n], A.addClass(s), m = A.css("background-image").match(/^url\("(.*)"\)$/)) t += "." + s + "{background:none; filter : progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + m[1] + "', sizingMethod='scale'); } ",
                    A.removeClass(s);
